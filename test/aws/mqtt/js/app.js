...
(function() {
  ...
  function AppController(scope){
    ...
    vm.secretKey=null;
    vm.clientId = makeid();
    vm.regionName = 'us-west-2';
    vm.endpoint = 'a3ouzdnoo71f3j-ats.iot.us-west-2.amazonaws.com';
    ...
    setTimeout(async function(){
      ...
      await new Promise(function(resolve,reject){
        vm.passphrase=prompt("Enter Passphrase","");
        var encStrs=[
          'U2FsdGVkX1+TGwlnpyc8i8+MH58RNnAyo8up0hAvM6HUlU6sEVdv3Q1IZZJO7ha5',
          'U2FsdGVkX18x8Dkc0AedHTdJcbJNNrT27O3XPhUbs75pM+gR9jq6zc0/NwHV92KsUE2ofuucC6Msra4xVY67JQ==',
          'U2FsdGVkX1+VwfP7vwYhz1ZpH74cdc4nAkoAwaz9lYXLcompvMP1mPqVYnjX/m8x',
          'U2FsdGVkX19EEQqaZy/O262k7syfB8EFvElc9s9ekFEZSJ1e2L+R7v+5Mxg+NV5lfZtOuWzBQt023IYnzyT50A=='
        ];
        try{
          encStrs.map(function(v,i,a){
            decStrs.push(CryptoJS.AES.decrypt(v, vm.passphrase).toString(CryptoJS.enc.Utf8));
          });
        }catch(e){
          decStrs=['','','',''];
        }
        vm.accessKey = decStrs[2];
        vm.secretKey = decStrs[3];
        resolve();
      });
      if(decStrs[0]!==''){
        vm.ready=true;
